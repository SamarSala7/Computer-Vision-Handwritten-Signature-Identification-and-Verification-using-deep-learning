...
Original file is located at
    https://colab.research.google.com/drive/1AsnTKL0fkH0RqvzqjGz9hBB6McfKfCVB
"""
    ...
    with open(input_path, 'r') as f:
        ...
        for line in f:
            ...
            if filename not in all_imgs:
                ...
                img = cv2.imread('/content/TrainImages/' + filename)
...
def augment(img_data, config, augment=True):
    ...
    img = cv2.imread('TrainImages/' + img_data_aug['filepath'], cv2.IMREAD_UNCHANGED)
...
train_path = '/content/data.csv' # Training data (annotation file)
...
output_weight_path = '/content/sample_data/model_frcnn_vgg.hdf5'

# Record data (used to save the losses, classification accuracy and mean average precision)
record_path = '/content/sample_data/record.csv'
...
#visualize_data_gen_train(data_gen_train,C)
...
!unzip -q /content/sample_data/TrainImages.zip
